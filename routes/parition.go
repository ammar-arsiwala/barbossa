...
func Partition(app *fiber.App, cli *client.Client) {
	app.Post("/partition", func(c *fiber.Ctx) error {
		trace.Logf(c.Context(), "HTTP Request", "/partition")
		...
		cmds := service.NewPartition(req, naiveEndpointStorage)
